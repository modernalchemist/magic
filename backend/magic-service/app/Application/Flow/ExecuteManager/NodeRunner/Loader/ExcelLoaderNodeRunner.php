...
#[FlowNodeDefine(type: NodeType::ExcelLoader->value, code: NodeType::ExcelLoader->name, name: '电子表格解析', paramsConfig: ExcelLoaderNodeParamsConfig::class, version: 'v0', singleDebug: true, needInput: false, needOutput: true)]
