...
class OpenTaskApi extends AbstractApi
{
     ...
     * @param \App\Infrastructure\Util\Context\RequestContext $requestContext
     * @return array
     */
     ...
     * @param \App\Infrastructure\Util\Context\RequestContext $requestContext
     * @param \Dtyq\SuperMagic\Interfaces\SuperAgent\DTO\Request\CreateAgentTaskRequestDTO $requestDTO
     * @return array
     */
    #[ApiResponse('low_code')]
     ...
     * @param \App\Infrastructure\Util\Context\RequestContext $requestContext
     * @param \Dtyq\SuperMagic\Interfaces\SuperAgent\DTO\Request\CreateScriptTaskRequestDTO $requestDTO
     * @return array
     */
    #[ApiResponse('low_code')]
